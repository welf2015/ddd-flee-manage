...
const INSPECTION_CATEGORIES = [
  {
    title: "Handbook",
    items: [{ key: "handbook_sops_available", label: "SOPs, 999 directory" }],
  },
  {
    title: "Exterior Inspection",
    items: [
      { key: "body_condition", label: "Branding Condition" },
  ...
  },
  {
    ...
    items: [
      { key: "tire_tread_depth", label: "Tire" },
  ...
  },
  {
    ...
    items: [{ key: "exhaust_pipe", label: "Exhaust pipe" }],
  },
  {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const inspectionData: any = {
        ...
        odometer_reading: formData.odometer_reading ? Number.parseInt(formData.odometer_reading) : null,
            ...
            <div className="space-y-4">
              ...
              {inspection?.supervisor_review && (
                <div>
                  ...
                  <Textarea value={inspection.supervisor_review} disabled className="border-red-200 bg-red-50" />
                </div>
              )}
            </div>
          ...
          <TabsContent value="photos" className="space-y-6 mt-6">
            {inspectionPhotos.length > 0 ? (
                ...
                {inspectionPhotos.map((photo) => (
                  <div key={photo.id} className="border rounded-lg overflow-hidden">
                    ...
                    <div className="p-3 space-y-1">
                      ...
                      {photo.captured_at && (
                        <p className="text-xs text-muted-foreground">{new Date(photo.captured_at).toLocaleString()}</p>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="text-center py-12 text-muted-foreground">
                ...
                {!isReadOnly && <p className="text-sm mt-2">Photos can be uploaded via the mobile app</p>}
              </div>
            )}
          </TabsContent>
        </Tabs>
